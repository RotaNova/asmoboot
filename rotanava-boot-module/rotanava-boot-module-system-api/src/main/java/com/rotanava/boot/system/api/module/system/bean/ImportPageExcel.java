...
@Data
@ExcelTag(tag = "页面权限列表")
public class ImportPageExcel implements Serializable {
    /**
     * 所属模块
     */
     ...
     * *是否可见（可见/不可见）
     */
    @ExcelTag(tag = "*是否可见（可见/不可见）",width = 3000 ,index = 6)
    private String pageShow;

    /**
     * 是否全员可见（是/否）
     */
    @ExcelTag(tag = "*是否全员可见（是/否）",width = 3000 ,index = 7)
    private String visibleToAll;

    /**
     * *是否外链（是/否）
     */
    @ExcelTag(tag = "*是否外链（是/否）",width = 3000 ,index = 8)
    private String isJump;

    /**
     * 页面资源状态（未激活/正常/过期）
     */
    @ExcelTag(tag = "*页面资源状态（未激活/正常/过期）",width = 3000 ,index = 9)
    private String pageStatus;

    /**
     *页面资源类型（一级菜单/子菜单/接口权限）
     */
    @ExcelTag(tag = "*页面资源类型（一级菜单/子菜单/接口权限）",width = 3000 ,index = 10)
    private String pageType;

    /**
     * 页面类型（增/删/改/查，页面资源类型为接口权限时需填写此项）
     */
    @ExcelTag(tag = "*页面类型（增/删/改/查，页面资源类型为接口权限时需填写此项）",width = 3000 ,index = 11)
    private String abilityType;

    /**
     * 父节点（填写父节点的页面编码，页面资源类型为一级菜单时，此内容无效）
     */
    @ExcelTag(tag = "父节点（填写父节点的页面编码，页面资源类型为一级菜单时，此内容无效）",width = 3000 ,index = 12)
     ...
     * *是否自动生成（是/否）
     */
    @ExcelTag(tag = "*是否自动生成（是/否）",width = 3000 ,index = 14)
    private String isAuto;

    /**
     * *代码（是否自动生成为否时，此项无需填写）
     */
    @ExcelTag(tag = "*代码（是否自动生成为否时，此项无需填写）",width = 3000 ,index = 15)
     ...
     * 失败的原因
     */
    @ExcelTag(tag = "失败的原因",width = 3000 ,index = 17)
