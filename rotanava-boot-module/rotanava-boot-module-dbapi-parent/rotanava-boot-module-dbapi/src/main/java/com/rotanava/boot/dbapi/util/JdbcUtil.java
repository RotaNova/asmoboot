...
public class JdbcUtil {
    ...
    public static Connection getConnection(OpenDataSource ds) throws SQLException {
        try {
            Class.forName(ds.getDriver());
            Connection connection = DriverManager.getConnection(ds.getUrl(), ds.getUserName(), ds.getUserPassword());
            log.info("获取连接成功");
            return connection;
    ...
    public static ExecuteResult executeSql(OpenDataSource datasource, String sql, List<Object> jdbcParamValues) {
        ...
        try {
            ...
            if (hasResultSet) {
                ...
                return ExecuteResult.listResult(list);
            } else {
                int updateCount = statement.getUpdateCount();
                return ExecuteResult.updateResult(updateCount);
            }
        } catch (Exception e) {
            if (e instanceof CommonException){
                ...
                return ExecuteResult.errorResult(e.getMessage());
            }
        } finally {
            try {
                if (connection != null)
