...
@Validated
@RestController
@RequestMapping("/v1/sysAnnouncementSys")
public class SysAnnouncementSysController {
    ...
    public RetData<IPage<AnnouncementItemVO>> getAnnouncementItemPage(@RequestBody GetAnnouncementItemPageDTO announcementItemPageDTO) {
        announcementItemPageDTO.setAnnCategory(AnnCategory.SYSTEM_INFORMATION.getType());
    ...
    @AutoLog(value = "发布通告", operateType = OperateTypeEnum.ADD)
    @AdviceResponseBody
