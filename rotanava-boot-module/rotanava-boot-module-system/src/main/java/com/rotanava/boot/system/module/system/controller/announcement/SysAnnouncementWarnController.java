...
@Validated
@RestController
@RequestMapping("/v1/sysAnnouncementWarn")
public class SysAnnouncementWarnController {
    ...
    public RetData<IPage<AnnouncementItemVO>> getAnnouncementItemPage(@RequestBody GetAnnouncementItemPageDTO announcementItemPageDTO) {
        announcementItemPageDTO.setAnnCategory(AnnCategory.WARNING_MESSAGE.getType());
